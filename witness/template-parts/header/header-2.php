                  ...
                  <nav class="main-nav float-end">
                     ...
                     <?php if ( !empty( $witnessai_header_right ) ): ?>
                        <div class="inner-contact-options d-xl-none d-inline-flex flex-column  px-3">
                           <a href="<?php echo esc_html( $witnessai_head_btn_one_link ); ?>" class="btn-transparent-xl btn-transparent-v2 mb-3"><?php echo esc_html( $witnessai_head_btn_one ); ?></a>
                           <a href="<?php echo esc_html( $witnessai_head_btn_two_link ); ?>" class="btn-fill-pill md-btn"><?php echo esc_html( $witnessai_head_btn_two ); ?></a>
                        </div>
                     <?php endif; ?>
               ...
               <?php if ( !empty( $witnessai_header_right ) ): ?>
                    <div class="col-xl-3">
                        <div class="nav-right float-end d-xl-flex d-none">
                            <a href="<?php echo esc_html( $witnessai_head_btn_one_link ); ?>" class="btn-transparent-xl btn-transparent-v2"><?php echo esc_html( $witnessai_head_btn_one ); ?></a>
                            <a href="<?php echo esc_html( $witnessai_head_btn_two_link ); ?>" class="btn-fill-pill md-btn"><?php echo esc_html( $witnessai_head_btn_two ); ?><span></span></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
